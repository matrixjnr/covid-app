...
public class DashboardChart extends VerticalLayout {
    ...
    public DashboardChart(String title, ChartType chartType, List<DayUtil> statsList, Function<DayUtil, Long> casesFunction, Function<DayUtil, Long> deathsFunction, Function<DayUtil, Long> recoveredFunction) {
